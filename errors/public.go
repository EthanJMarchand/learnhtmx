...
// that will return a message this is acceptable to display to the public. This error
// can also be unwrapped using the traditional errors package approach.
func Public(err error, msg string) error {
	return publicError{err, msg}
}

// PublicError is a struct and it helps us with errors.
